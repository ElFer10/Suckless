...
static const Rule rules[] = {
	...
	RULE(.class    = "Gimp", .isfloating=0, .tags = 1 << 3)
...
static Key keys[] = {
	...
	{ 0,                            XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer -c 1 set 'PCM' 10%+") },
	{ MODKEY,                       XF86XK_AudioRaiseVolume,	spawn,		SHCMD("amixer -c 1 set 'Master' 10%+") },
	{ 0,                            XF86XK_AudioLowerVolume,	spawn,		SHCMD("amixer -c 1 set 'PCM' 10%-") },
	{ MODKEY,                       XF86XK_AudioLowerVolume,	spawn,		SHCMD("amixer -c 1 set 'Master' 10%+") },
